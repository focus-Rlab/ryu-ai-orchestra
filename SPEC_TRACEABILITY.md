...
`MASTER_SPEC.md`の各決定が、日常運用で使用する分割正本のどこへ反映されているかを追跡する。

重要変更時は、本表の対応先をすべて確認する。対応先が空欄、曖昧、矛盾している場合は、実装やmain反映を止めて修正する。

| MASTER_SPEC項目 | 主な分割正本 | 状態 |
|---|---|---|
...
| 4.2 タスク分解・詳細項目 | ROADMAP.md / agents/raphael.md | 本PRで補強 |
...
| 14. 正本管理 | README.md / GOVERNANCE.md / OPERATING_GUIDE.md | 本PRで補強 |
...
| 18. 実装前チェック | ROADMAP.md / OPERATING_GUIDE.md | 本PRで補強 |
| 19. 実装順序 | ROADMAP.md | 本PRで更新 |

## 完全性ルール

- `MASTER_SPEC.md`に新しい重要項目を追加したら、本表にも追加する。
- 分割正本を変更したら、対応する行を再確認する。
- 「反映済み」とする前に、単語があるだけでなく意味と条件が保存されているか確認する。
- 完全版にしか存在しない運用必須事項を放置しない。
- 分割正本にしか存在しない重要事項が見つかった場合、完全版へ逆反映する。
